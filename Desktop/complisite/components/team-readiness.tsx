...
export function TeamReadiness({ projectId, onUpdate }: TeamReadinessProps) {
  ...
  if (loading) {
    return <div>Loading team readiness...</div>
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-bold">Team Readiness</h2>
