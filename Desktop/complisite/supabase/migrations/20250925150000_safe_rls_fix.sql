-- ============================================
-- SAFE RLS FIX - HANDLE EXISTING POLICIES
-- ============================================
-- 
-- This migration safely handles existing policies and deploys the RLS fix
-- ============================================
...
-- Drop policies that cause recursion (ignore if they don't exist)
